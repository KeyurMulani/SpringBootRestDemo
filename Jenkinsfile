node {
    stage('Configure') {
        ...
        properties([
                ...
                [$class: 'GithubProjectProperty', displayName: '', projectUrlStr: 'https://github.com/KeyurMulani/SpringBootRestDemo/'],
                pipelineTriggers([[$class: 'GitHubPushTrigger']])
            ])
    }

    stage('Checkout') {
        git 'https://github.com/KeyurMulani/SpringBootRestDemo'
    }
